...
public enum Chain {
    ...
    BSC(1009, "BSC", "Binance Smart Chain"),
    XDAI(1004, "XDAI", "XDAI"),
    HECO(1005, "HECO", "HECO"),
    OPTIMISM(1010, "OPTIMISM", "Optimism"),
    MOONRIVER(1006, "MOONRIVER", "Moonriver"),
    AVALANCHE(1007, "AVALANCHE", "Avalanche"),
    ARBITRUM(1008, "ARBITRUM", "Arbitrum"),
